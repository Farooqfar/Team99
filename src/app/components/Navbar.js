    ...
    <>
      <nav className=" w-ful h-20 flex items-center justify-between  bg-white/10 backdrop-blur-xl overflow-hidden pr-3">
        ...
        <ul className="text-white flex justify-center items-center w-full h-full gap-12">
          <li className="relative text-xl text-[#1E57F6] hover:text-[#F37A0E] hover:cursor-pointer before:content-[''] before:w-0 before:h-0.5 before:rounded before:bg-[#F37A0E] before:absolute before:bottom-0 before:left-0 hover:before:w-full  before:transition-all before:duration-200 transition-all duration-150 ease-in">
            Home
          </li>
          <li className="relative text-xl text-[#1E57F6] hover:text-[#F37A0E] hover:cursor-pointer before:content-[''] before:w-0 before:h-0.5 before:rounded before:bg-[#F37A0E] before:absolute before:bottom-0 before:left-0 hover:before:w-full before:transition-all before:duration-200 transition-all duration-150 ease-in">
            About Us
